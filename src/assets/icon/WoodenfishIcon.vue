...
.wooden-fish {
  cursor: pointer;
  animation:shake_1 1.0s infinite;
}
@keyframes shake_1 {
	20%{
    transform: rotate(8.5deg);
    filter: drop-shadow(8px 8px 35px #fcfa7e);
  }
	40% { 
  ...
  60%, 80% {
    transform:  rotate(0);
    filter: drop-shadow(2px 2px 5px rgba(255, 255, 255, .6));
  }
	0%, 100% { 
    transform: rotate(0);
    filter: drop-shadow(2px 2px 5px rgba(255, 255, 255, .6));
